...
required to run a [Timelord](https://github.com/Kale-Network/kale-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Kale-Network/kale-blockchain/blob/main/install-timelord.sh)

...
def show_plots(root_path: Path):
    from kale.plotting.plot_tools import get_plot_directories

    print("Directories where plots are being searched for:")
    print("Note that subdirectories must be added manually")
    print(
        "Add with 'kale plots add -d [dir]' and remove with"
        + " 'kale plots remove -d [dir]'"
        + " Scan and check plots with 'kale plots check'"
    )
    print()
...
def check_cmd(
    ...
    from kale.plotting.check_plots import check_plots
...
def add_cmd(ctx: click.Context, final_dir: str):
    from kale.plotting.plot_tools import add_plot_directory
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from kale.plotting.plot_tools import remove_plot_directory

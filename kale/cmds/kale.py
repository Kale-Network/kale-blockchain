...
from kale.cmds.configure import configure_cmd
from kale.cmds.farm import farm_cmd
from kale.cmds.init import init_cmd
from kale.cmds.keys import keys_cmd
from kale.cmds.netspace import netspace_cmd
from kale.cmds.plots import plots_cmd
from kale.cmds.show import show_cmd
from kale.cmds.start import start_cmd
from kale.cmds.stop import stop_cmd
from kale.cmds.wallet import wallet_cmd
...
@click.group(
    help=f"\n  Manage kale blockchain infrastructure ({__version__})\n",
    epilog="Try 'kale start node', 'kale netspace -d 192', or 'kale show -s'",
...
@cli.command("version", short_help="Show kale version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs kale daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from kale.daemon.server import async_run_daemon
    import asyncio

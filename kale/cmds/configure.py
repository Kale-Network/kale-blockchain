...
from kale.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            mainnet_port = "6333"
            mainnet_introducer = "introducer.kalenetwork.org"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running kale services for changes to take effect")

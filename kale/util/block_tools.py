...
from kale.consensus.block_creation import create_unfinished_block, unfinished_block_to_full_block
...
from kale.util.wallet_tools import WalletTool
...
class BlockTools:
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "xka")

...
def class_for_type(type: NodeType) -> Any:
    if type is NodeType.FULL_NODE:
        ...
        from kale.introducer.introducer_api import IntroducerAPI

        return IntroducerAPI
    elif type is NodeType.TIMELORD:
        from kale.timelord.timelord_api import TimelordAPI
        ...
        from kale.harvester.harvester_api import HarvesterAPI

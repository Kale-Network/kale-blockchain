...
from kale.wallet.puzzles.puzzle_utils import (
...
from kale.wallet.secret_key_store import SecretKeyStore
from kale.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_kale(self, kale_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if kale_amount < 0:
            utxos = await self.select_coins(abs(kale_amount), exclude)
        else:
        ...
        kale_amount = spend_value + kale_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": kale_amount}]

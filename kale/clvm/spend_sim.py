...
from kale.util.ints import uint64, uint32
...
from kale.consensus.coinbase import create_pool_coin, create_farmer_coin
...
"""
The purpose of this file is to provide a lightweight simulator for the testing of Kalelisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from kale.rpc.full_node_rpc_client

...
from kale.cmds.init_funcs import kale_full_version_str
from kale.protocols.protocol_message_types import ProtocolMessageTypes
from kale.protocols.shared_protocol import Capability, Handshake
from kale.server.outbound_message import Message, NodeType, make_msg
from kale.server.rate_limits import RateLimiter
...
from kale.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from kale.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSKaleConnection:
    """

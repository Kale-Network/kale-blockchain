...
describe("units", () => {
  describe("#getUnit", () => {
    it("gets unit of kale", () => {
      const result = units.getUnit("kale");
    ...
    it("gets unit of kale using alias", () => {
  ...
  describe("#getDisplay", () => {
    it("gets display of kale", () => {
      const result = units.getDisplay("kale");
  ...
  describe("#setUnit", () => {
    ...
    it("modifies an existing unit", () => {
      units.setUnit("kale", 9);

      const result = units.getUnit("kale");

      expect(result).toEqual(9);

      units.setUnit("kale", 1);
    });
  });
  describe("#setDisplay", () => {

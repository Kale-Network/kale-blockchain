...
import { Card, FormatLargeNumber, Link, Loading, TooltipIcon, Flex } from '@kale/core';
import {
  unix_to_short_date,
  hex_to_array,
  arr_to_hex,
...
export default function Block() {
  ...
  const baseFarmerReward = mojo_to_kale(calculateBaseFarmerReward(blockRecord.height));

...
import { Link, Table, Card, FormatBytes } from '@kale/core';
    ...
    <Card
      ...
      tooltip={(
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Kale-Network/kale-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it">Learn more</Link>
        </Trans>
      )}
      interactive
    >

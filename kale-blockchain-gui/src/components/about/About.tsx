...
import icon from '../../assets/img/kale_circle.svg';
...
const url = 'https://kalenetwork.org';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Chia Network, Kale Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Kale-Network/kale-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>

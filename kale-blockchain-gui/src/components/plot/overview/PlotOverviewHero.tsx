...
import { CardHero, Link } from '@kale/core';
import { PlotHero as PlotHeroIcon } from '@kale/icons';
        ...
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              ...
              <Link target="_blank" href="https://github.com/Kale-Network/kale-blockchain/wiki/Network-Architecture">Learn more</Link>
            </Trans>
          </Typography>
          <Button

...
import { Button, CardStep, Select, Flex, Loading } from '@kale/core';
import {
  Box,
  Grid,
  FormControl,
  ...
  if (showCreatePlotNFT) {
    return (
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent XKA farming rewards. The average
    ...
    >
      ...
      {!loading && !hasNFTs && (
        <>
          <Typography variant="subtitle1">
            <Trans>
              Join a pool and get more consistent XKA farming rewards. Create a

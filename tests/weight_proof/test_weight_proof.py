...
from kale.server.start_full_node import SERVICE_NAME
...
from kale.consensus.pot_iterations import calculate_iterations_quality
from kale.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,

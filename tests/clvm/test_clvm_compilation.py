...
wallet_program_files = set(
    [
        "kale/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "kale/wallet/puzzles/cc.clvm",
        "kale/wallet/puzzles/kalelisp_deserialisation.clvm",
        "kale/wallet/puzzles/rom_bootstrap_generator.clvm",
        "kale/wallet/puzzles/generator_for_single_coin.clvm",
        "kale/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "kale/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "kale/wallet/puzzles/lock.inner.puzzle.clvm",
        "kale/wallet/puzzles/p2_conditions.clvm",
        "kale/wallet/puzzles/p2_delegated_conditions.clvm",
        "kale/wallet/puzzles/p2_delegated_puzzle.clvm",
        "kale/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "kale/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "kale/wallet/puzzles/p2_puzzle_hash.clvm",
        "kale/wallet/puzzles/rl_aggregation.clvm",
        "kale/wallet/puzzles/rl.clvm",
        "kale/wallet/puzzles/sha256tree_module.clvm",
        "kale/wallet/puzzles/singleton_top_layer.clvm",
        "kale/wallet/puzzles/did_innerpuz.clvm",
        "kale/wallet/puzzles/decompress_puzzle.clvm",
        "kale/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "kale/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "kale/wallet/puzzles/block_program_zero.clvm",
        "kale/wallet/puzzles/test_generator_deserialize.clvm",
        "kale/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
    ]
)

clvm_include_files = set(
    ["kale/wallet/puzzles/create-lock-puzzlehash.clvm", "kale/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "kale/wallet/puzzles"

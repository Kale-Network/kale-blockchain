...
from kale.server.server import ssl_context_for_server
from kale.types.peer_info import PeerInfo
from kale.util.block_tools import BlockTools
from kale.util.ints import uint16
from kale.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, simulation, get_daemon):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "kale_full_node")
        await ws.send_str(payload)

...
from kale.pools.pool_config import PoolWalletConfig
from kale.util.config import load_config, save_config, create_default_kale_config
...
def test_pool_config():
    ...
    create_default_kale_config(test_root, ["config.yaml"])

...
from kale.wallet.puzzles.p2_conditions import puzzle_for_conditions
from kale.wallet.puzzles import singleton_top_layer
from kale.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - kale.pools.pool_puzzles.py
    - kale.wallet.puzzles.pool_member_innerpuz.clvm
    - kale.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
